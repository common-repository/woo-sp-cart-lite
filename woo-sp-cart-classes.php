<?php
global $woo_sp_cart;
$woo_sp_cart = new WooSpCartWidget();

class WooSpCartWidget{
...
<?php
    ...
    function show_widget_options() {
        $id_widget = $_POST['id_base'];
        if($id_widget == 'woo_sp_cart_button_widget'){
...
?>   
    <p>
        <label for="<?php echo $widget->get_field_id('dw_include'); ?>"><?php _e('Show Widget for:', 'woo_sp_cart_lite') ?></label>
        <select name="<?php echo $widget->get_field_name('dw_logged'); ?>" id="<?php echo $widget->get_field_id('dw_logged'); ?>" class="widefat">
            <option value=""><?php _e('Everyone', 'woo_sp_cart_lite') ?></option>
            <option value="out" <?php echo selected( $instance['dw_logged'], 'out' ) ?>><?php _e('Logged-out users', 'woo_sp_cart_lite') ?></option>
            <option value="in" <?php echo selected( $instance['dw_logged'], 'in' ) ?>><?php _e('Logged-in users', 'woo_sp_cart_lite') ?></option>
        </select>
    </p>

     <p>
    	<select name="<?php echo $widget->get_field_name('dw_include'); ?>" id="<?php echo $widget->get_field_id('dw_include'); ?>" class="widefat">
            <option value="0"><?php _e('Hide on checked pages', 'woo_sp_cart_lite') ?></option> 
            <option value="1" <?php echo selected( $instance['dw_include'], 1 ) ?>><?php _e('Show on checked pages', 'woo_sp_cart_lite') ?></option>
        </select>
    </p>    

<div style="height:150px; overflow:auto; border:1px solid #dfdfdf; padding:5px; margin-bottom:5px;">
    <h4 class="dw_toggle" style="cursor:pointer;margin-top:0;"><?php _e('Miscellaneous', 'woo_sp_cart_lite') ?> +/-</h4>
    ...
    ?>
        ...
        <label for="<?php echo $widget->get_field_id('page-'. $key); ?>"><?php echo $label .' '. __('Page', 'woo_sp_cart_lite') ?></label></p>
    <?php } ?>
    </div>
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php _e('Custom Post Types', 'woo_sp_cart_lite') ?> +/-</h4>
    <div class="dw_collapse">
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php _e('Custom Post Type Archives', 'woo_sp_cart_lite') ?> +/-</h4>
    <div class="dw_collapse">
    <?php foreach ( $this->cposts as $post_key => $custom_post ) {
    ...
    ?>
        ...
        <label for="<?php echo $widget->get_field_id('type-'. $post_key .'-archive'); ?>"><?php echo stripslashes($custom_post->labels->name) ?> <?php _e('Archive', 'woo_sp_cart_lite') ?></label></p>
    <?php } ?>
    </div>
    <?php } ?>
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php _e('Taxonomies', 'woo_sp_cart_lite') ?> +/-</h4>
    <div class="dw_collapse">
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php _e('Languages', 'woo_sp_cart_lite') ?> +/-</h4>
    <div class="dw_collapse">
    ...
    <p><label for="<?php echo $widget->get_field_id('other_ids'); ?>"><?php _e('Comma Separated list of IDs of posts not listed above', 'woo_sp_cart_lite') ?>:</label>
...
<?php
    ...
    function page_types(){
        $page_types = array(
            'front'     => __('Front', 'woo_sp_cart_lite'), 
            'home'      => __('Blog', 'woo_sp_cart_lite'),
            'archive'   => __('Archives'),
